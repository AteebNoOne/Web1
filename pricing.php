   ...
   <div class="swiper reviews-slider">
      ...
      <div class="swiper-wrapper">
         ...
         <div class="swiper-slide slide">
            ...
            <h3>Laiba Owais</h3>
            <p>Best Services.It was wonderful experience.</p>
            <div class="stars">
         ...
         <div class="swiper-slide slide">
            ...
            <h3>Dua Khan</h3>
            <p>Fantastic services will surely book again.</p>
            <div class="stars">
               <i class="fas fa-star"></i>
               <i class="fas fa-star"></i>
               <i class="fas fa-star"></i>
         ...
         <div class="swiper-slide slide">
            ...
            <h3>Asad Ahmed</h3>
            <p>Loved their professional way and services.</p>
            <div class="stars">
               <i class="fas fa-star"></i>
               <i class="fas fa-star"></i>
               <i class="fas fa-star"></i>
         ...
         <div class="swiper-slide slide">
            ...
            <h3>Maaz Khan</h3>
            <p>Highly recommended best services.</p>
            <div class="stars">
               <i class="fas fa-star"></i>
               <i class="fas fa-star"></i>
               <i class="fas fa-star"></i>
